...
- No change of hardware. Supports  s since 2018+. Minimum  Capability 7.0 (V100, T4, Titan V, RTX 20, 30, 40x, A100, H100, L40 etc) [Check your !](https://developer..com/-s) GTX 1070, 1080 works, but is slow.
...
conda create --name unsloth_env \
    python=3.11 \
    pytorch-=12.1 \
    pytorch toolkit xformers -c pytorch -c  -c xformers \
    -y
...
```python
import os
os.environ["_VISIBLE_DEVICES"] = "0" # Optional set   ID
