...
def _patch_trl_rl_trainers(trainer_file = "grpo_trainer"):
    ...
    # Add out_dir saving
    if "out_dir" in call_args:
        # Default checks
        saving_check = \
        "if out_dir is None and save_strategy == 'steps' and save_steps == 500:\n"\
        "    out_dir = 'unsloth_training_checkpoints'\n"\
        "    save_strategy = 'no'\n"
    ...
    if "dataset_num_proc" in call_args:
        ...
        "    from multiprocessing import _count\n"\
        "    dataset_num_proc = _count()\n"
