    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        statistics = \
           ...
           f"   \\\   /|    : {_stats.name}. Max memory: {max_memory} GB. Platform: {platform_system}.\n"\
           f"O^O/ \_/ \\    Torch: {torch.__version__}. : {_stats.major}.{_stats.minor}.  Toolkit: {torch.version.}. Triton: {triton_version}\n"\
